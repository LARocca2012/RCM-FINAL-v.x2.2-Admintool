...
require $cpath.'cfg/all_groups_control.php';
//********************************************************
...
try
  {
    $db3 = new PDO('sqlite:'.$cpath . 'ReCodMod/databases/db3.sqlite');
    $result = $db3->query("SELECT * FROM x_db_play_stats WHERE s_kills>=50 AND s_lasttime LIKE '%".$daten."%' ORDER BY (s_ratio+0) DESC LIMIT 5");
 		$number = 0;
    $i = 0;
