...
if ($x_stop_lp == 0) {
    if ((strpos($parseline, 'J;') != false) || (strpos($parseline, 'InitGame: ') != false) || (strpos($parseline, 'RestartGame:') != false) || (strpos($parseline, 'L;') != false) || (strpos($parseline, 'W;') != false) || (strpos($parseline, '-----------------------------------') != false)) 
    {
        ...
        else if ($game_patch == 'cod4') list($x1e, $x2e, $x3e, $x4e) = explode(';', $parseline);
        else
        //--------  4471:49Q;0;2;xxx
...
usleep(10300);
            ...
            if ($stat > 0) {
                ...
                if ($stat > 0) {
                    ...
                    if (!empty($ippppp)) $x4i = $ippppp;
                    else $x4i = '';
                    if (!empty($ippppp)) {
                        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        /////////////////////////////////////FALSE LOST CONNECT FIX GUID/////////////////////////////////////////////////
                        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        if ($guids == 0) $mdguid = md5(md5(md5($x4e)));
                        else $mdguid = $x2e;
 ...
 VALUES ('$x4vvv','$place','$kilsss','$deathsss','$nadesss','$iskill','$iratio','$headsss','$timee','$lasttime','','$clc','$mdguid','$cgeo','$suicides','','$melles')");
        ...
        echo '-> EXIT ' . $x4e . ' ' . (microtime(true) - $start);
        exit;
        /////////////////////////////////
        ...
        if (strpos($parseline, 'K;') != false) {
            //echo '-------------';
            ///////////////////////////
            require $cpath.'cfg/all_connection.php';
            require $cpath.'cfg/all_settings.php';
            ///////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            if ($guids == 0) {
                                ...
                                foreach ($result as $row) {
                                    ...
                                    if ($kl <= 0 || $dth <= 0) {
                                        ...
                                        echo '    ' . substr((microtime(true) - $start), 0, 4);
                                    }
                                }
